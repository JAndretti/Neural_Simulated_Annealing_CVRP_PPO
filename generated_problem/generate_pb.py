...
if __name__ == "__main__":
    sh_file = glob2.glob("generated_problem/scripts_gen/*.sh")
    ...
    for file in sh_file:
        ...
        try:
            ...
            dir_path = f"generated_problem/bdd_generated/gen{number}"
            ...
            os.system(f"cp generated_problem/generator.py {dir_path}/")
